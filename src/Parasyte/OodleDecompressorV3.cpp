...
ps::OodleDecompressorV3::OodleDecompressorV3(ps::FileHandle& file, bool secure) :
...
size_t ps::OodleDecompressorV3::Decompress(uint8_t* input, size_t inputSize, uint8_t* output, size_t outputSize)
{
	return ps::oodle::Decompress(input, inputSize, output, outputSize);
}

size_t ps::OodleDecompressorV3::Read(void* ptr, const size_t size, const size_t offset)
{
