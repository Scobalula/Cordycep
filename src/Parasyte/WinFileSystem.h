...
namespace ps
{
	...
	public:
		...
		virtual size_t EnumerateFiles(const std::string& directory, const std::string& pattern, bool topDirectory, std::function<void(const std::string&, const size_t)> onFileFound);
	};
}